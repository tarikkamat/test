(function() {
	...
	const { __ } = wp.i18n;
	const { Button, Card, CardBody, CardHeader, Notice, SelectControl, TextControl, Flex, FlexItem, Spinner, DatePicker, PanelBody, PanelRow } = wp.components;
	...
	function App() {
		...
		return h(Fragment, {}, [
			...
			h('div', { style: { marginTop: 12, position: 'relative' } }, [
				...
				h(Table, { items, onAction: handleAction })
			])
		]);
	}
